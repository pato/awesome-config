...
-- {{{ Tags
tags = {
   names = { " WEB ", " TERM ", " WORK ", " MUSIC ", " IRC ", " FILES ", " CHAT "},
   layout = { layouts[2], layouts[3], layouts[2], layouts[2], layouts[2], layouts[2], layouts[1]}
}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey }, "p", function() os.execute("scrot -e 'mv $f ~/Pictures/screenshots/'") end),
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.util.spawn(crtterm) end),
